...
description: <ul style="list-style-type:disc">
                ...
                <li>Reduced execution time from days to hours by using a computer cluster</li>
                <li>Designed and implemented a high performance computing toolkit with parallel computing APIs</li>
                <li>Designed and implemented data processing and visualization pipelines with scientific computing APIs</li>
